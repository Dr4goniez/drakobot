...
import { ApiDeleteResponse, ApiEditResponse, ApiMoveResponse, ApiPage, ApiResponse, ApiRevision, ApiRollbackResponse, ApiSearchResult, ApiUndeleteResponse, ApiUploadResponse } from './api_response_types';
...
export declare class Mwn {
     ...
     */
    edit(title: string | number, transform: EditTransform, editConfig?: editConfigType): Promise<ApiEditResponse>;
    /**
